...
setwd("\Users\jelle\Dropbox\uni\jaar3\SCPgit\ACTR_model_output")  #Jelle ## set your workspace to the path where your output files are.
...
dat<- matrix(nrow=100, ncol=17) 
#2)produce a character vector of the names of txt output files in the named directory and assign it to "files" below.
files<- c("dat-0.txt", "dat-1.txt", "dat-2.txt", "dat-3.txt", "dat-4.txt", "dat-5.txt", "dat-6.txt", "dat-7.txt", "dat-8.txt", "dat-9.txt", "dat-10.txt", "dat-11.txt", "da
t-12.txt", "dat-13.txt", "dat-14.txt", "dat-15.txt", "dat-16.txt", "dat-17.txt", "dat-18.txt", "dat-19.txt", "dat-20.txt", "dat-21.txt", "dat-22.txt", "dat-23.tx
t", "dat-24.txt", "dat-25.txt", "dat-26.txt", "dat-27.txt", "dat-28.txt", "dat-29.txt", "dat-30.txt", "dat-31.txt", "dat-32.txt", "dat-33.txt", "dat-34.txt", "da
t-35.txt", "dat-36.txt", "dat-37.txt", "dat-38.txt", "dat-39.txt", "dat-40.txt", "dat-41.txt", "dat-42.txt", "dat-43.txt", "dat-44.txt", "dat-45.txt", "dat-46.tx
t", "dat-47.txt", "dat-48.txt", "dat-49.txt", "dat-50.txt", "dat-51.txt", "dat-52.txt", "dat-53.txt", "dat-54.txt", "dat-55.txt", "dat-56.txt", "dat-57.txt", "da
t-58.txt", "dat-59.txt", "dat-60.txt", "dat-61.txt", "dat-62.txt", "dat-63.txt", "dat-64.txt", "dat-65.txt", "dat-66.txt", "dat-67.txt", "dat-68.txt", "dat-69.tx
t", "dat-70.txt", "dat-71.txt", "dat-72.txt", "dat-73.txt", "dat-74.txt", "dat-75.txt", "dat-76.txt", "dat-77.txt", "dat-78.txt", "dat-79.txt", "dat-80.txt", "da
t-81.txt", "dat-82.txt", "dat-83.txt", "dat-84.txt", "dat-85.txt", "dat-86.txt", "dat-87.txt", "dat-88.txt", "dat-89.txt", "dat-90.txt", "dat-91.txt", "dat-92.tx
t", "dat-93.txt", "dat-94.txt", "dat-95.txt", "dat-96.txt", "dat-97.txt", "dat-98.txt", "dat-99.txt")
